  ...
  const menuItem = (name, link) => (
    <a
      ...
      className={`text-lg transition-all duration-200 ${
        active === name ? "text-blue-700 font-semibold" : "text-zinc-800 hover:text-blue-400"
      }`}
    >
      {name}
    </a>
  ...
  return (
    <div className='fixed top-5 left-0 w-full z-50 flex justify-center'>
      ...
      shadow-sm flex items-center justify-between'>
        ...
        {/* Desktop Menu */}
        <div className='hidden  md:flex text-md text-zinc-900 items-center md:gap-5 lg:gap-6'>
          {menuItem("Home", "#")}
  ...
  <div className="relative group">
    ...
    <span className="absolute -top-9 left-1/2 -translate-x-1/2
      ...
      ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        {/* Mobile Social Icons (Different Colors) */}
