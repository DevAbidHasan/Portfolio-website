...
const About = () => {
  return (
    <section className="lg:pt-32 w-full mx-auto md:pt-24 pt-15 bg-white dark:bg-gray-900">
      <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-16 lg:w-[90%] mx-auto">
